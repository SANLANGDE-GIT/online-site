  ...
  <div>
    ...
    <div v-swiper:mySwiper="swiperOption">
      <div class="swiper-wrapper">
        <div v-for="banner in banners" :key="banner.id" :style="'background:'+banner.color" class="swiper-slide">
                ...
                <li v-for="teacher in teachers" :key="teacher.id">
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a :title="teacher.title" :href="teacher.linkUrl">
                        <img :alt="teacher.title" :src="teacher.imageUrl" width="142">
                      </a>
                    </div>
                    <div class="mt10 hLh30 txtOf tac">
                      <a :title="teacher.title" :href="teacher.linkUrl" class="fsize18 c-666">{{ teacher.title }}</a>
                    </div>
                  </section>
                </li>
              </ul>
...
export default {
  ...
  async asyncData() {
    const bannerResponse = await cmsApi.getListByTypeId(1)
    const teacherResponse = await cmsApi.getListByTypeId(2)
    console.log(bannerResponse.data.items)
    return {
      banners: bannerResponse.data.items,
